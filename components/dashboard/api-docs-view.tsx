  ...
  },
  {
    ...
    params: [
      ...
      },
      {
        ...
        required: false,
        default: 'Economy',
        description: "Filter by cabin class: 'Economy' | 'Premium Economy' | 'Business'.",
      },
      {
        name: 'limit',
        type: 'integer',
        required: false,
        default: '50',
        description: 'Maximum number of fare records to return (max 200).',
      },
    ],
    exampleQuery: '/api/fares?route_id=DEL-BOM&booking_window=T+1&fare_class=Economy&limit=2',
    exampleResponse: {
      data: [
        {
